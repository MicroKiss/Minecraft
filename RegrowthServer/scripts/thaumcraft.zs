...
game.setLocalization("en_US", "sinisternode.research_page.info", "A common motif with the old obsidian totems was the presence of a sinister node, dark enough to corrupt the world around it. Maybe there is something to be learned from these, and recreating them syntheticially may prove insightful.");
